...
interface EnhancedTableProps {
  ...
  numSelected: number;
  onRequestSort: (event: React.MouseEvent<unknown>, property: keyof AttendeeState) => void;
...
function EnhancedTableHead(props: EnhancedTableProps) {
  ...
  const createSortHandler = (property: keyof AttendeeState) => (event: React.MouseEvent<unknown>) => {
...
export const AttendeesTable =  ({ attendees }: Props) => {
  ...
  const handleRequestSort = (event: React.MouseEvent<unknown>, property: keyof AttendeeState) => {
  ...
  const handleSelectAllClick = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (event.target.checked) {
      const newSelecteds = Object.values(attendees).map((n) => n.name?n.name:"no name");
        ...
        <TableContainer className={classes.container}>
          ...
          >
            <EnhancedTableHead
              ...
              rowCount={Object.values(attendees).length}
            />
            <TableBody>
