...
export class BackendStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    if (USE_CDN) {
      ...
      cdn = new cloudfront.CloudFrontWebDistribution(
        this,
        "WebsiteDistribution",
        {
          viewerCertificate: {
    ...
    const addCommonSetting = (f: lambda.Function) => {
      ...
      if (USE_CDN) {
        f.addEnvironment(
          "DEMO_ENDPOINT",
          `https://${cdn!.distributionDomainName}/index.html`
        );
      } else {
        f.addEnvironment(
          "DEMO_ENDPOINT",
          `https://${bucket.bucketDomainName}/index.html`
        );
      }
    ...
    // ( - ) auth
    const lambdaFuncRestAPIAuth = new lambda.Function(
      this,
      "ChimeRESTAPIAuth",
      {
    ...
    //// (1) Root Function
    const lambdaFunctionGetRoot: lambda.Function = new lambda.Function(
      this,
      "funcHelloWorld",
      {
    ...
    //// (2-1) Get Meetings
    const lambdaFunctionGetMeetings: lambda.Function = new lambda.Function(
      this,
      "funcGetMeetings",
      {
    ...
    //// (2-2) Post Meeting
    const lambdaFunctionPostMeeting: lambda.Function = new lambda.Function(
      this,
      "funcPostMeeting",
      {
    ...
    //// (2-3) Delete Meeting
    const lambdaFunctionDeleteMeeting: lambda.Function = new lambda.Function(
      this,
      "funcDeleteMeeting",
      {
    ...
    //// (2-4) Get Meeting
    const lambdaFunctionGetMeeting: lambda.Function = new lambda.Function(
      this,
      "funcGetMeeting",
      {
    ...
    //// (3-1) Get Attendee
    const lambdaFunctionGetAttendee: lambda.Function = new lambda.Function(
      this,
      "funcGetAttendee",
      {
    ...
    //// (3-2) Post Attendee
    const lambdaFunctionPostAttendee: lambda.Function = new lambda.Function(
      this,
      "funcPostAttendee",
      {
    ...
    //// (3-3) list Attendees
    const lambdaFunctionGetAttendees: lambda.Function = new lambda.Function(
      this,
      "funcGetAttendees",
      {
    ...
    const lambdaFunctionPostAttendeeOperation: lambda.Function =
      new lambda.Function(this, "funcPostAttendeeOperation", {
    ...
    //// (5-1) Post Log
    const lambdaFunctionPostLog: lambda.Function = new lambda.Function(
      this,
      "funcPostLog",
      {
    ...
    const lambdaFunctionPostOperation: lambda.Function = new lambda.Function(
      this,
      "funcPostOperation",
      {
          ...
          integrationResponses: [
            {
              ...
              responseParameters: {
                "method.response.header.Access-Control-Allow-Headers":
                  "'Content-Type,X-Amz-Date,Authorization,X-Api-Key,X-Amz-Security-Token,X-Amz-User-Agent,X-Flect-Access-Token'",
    ...
    addCorsOptions(root);
    const addRoot = root.addMethod(
      "GET",
      new LambdaIntegration(lambdaFunctionGetRoot),
      {
    ...
    //// (2-1) Get Meetings
    apiMeetings.addMethod(
      "GET",
      new LambdaIntegration(lambdaFunctionGetMeetings),
      {
    ...
    apiMeetings.addMethod(
      "POST",
      new LambdaIntegration(lambdaFunctionPostMeeting),
      {
    ...
    //// (2-3) Delete Meeting
    apiMeeting.addMethod(
      "DELETE",
      new LambdaIntegration(lambdaFunctionDeleteMeeting),
      {
    ...
    apiMeeting.addMethod(
      "GET",
      new LambdaIntegration(lambdaFunctionGetMeeting),
      {
    ...
    //// (3-1) Get Attendee
    apiAttendee.addMethod(
      "GET",
      new LambdaIntegration(lambdaFunctionGetAttendee),
      {
    ...
    //// (3-2) Post Attendee
    apiAttendees.addMethod(
      "POST",
      new LambdaIntegration(lambdaFunctionPostAttendee),
      {
    ...
    apiAttendees.addMethod(
      "GET",
      new LambdaIntegration(lambdaFunctionGetAttendees),
      {
    ...
    const apiAttendeeOperation =
      apiAttendeeOperations.addResource("{operation}");
    addCorsOptions(apiAttendeeOperations);
    addCorsOptions(apiAttendeeOperation);

    //// (4-1) Post Attendee Operation
    apiAttendeeOperation.addMethod(
      "POST",
      new LambdaIntegration(lambdaFunctionPostAttendeeOperation),
      {
    ...
    //// (a-1) Post Onetime Code Signin Request
    apiOperation.addMethod(
      "POST",
      new LambdaIntegration(lambdaFunctionPostOperation),
      {
    ...
    //// Lambda Function
    // (1) connect
    const lambdaFuncMessageConnect = new lambda.Function(
      this,
      "ChimeMessageAPIConnect",
      {
        code: lambda.Code.asset(`${__dirname}/lambda`),
    ...
    // (2) disconnect
    const lambdaFuncMessageDisconnect = new lambda.Function(
      this,
      "ChimeMessageAPIDisconnect",
      {
        code: lambda.Code.asset(`${__dirname}/lambda`),
    ...
    // (3) message
    const lambdaFuncMessageMessage = new lambda.Function(
      this,
      "ChimeMessageAPIMessage",
      {
        code: lambda.Code.asset(`${__dirname}/lambda`),
    ...
    // (4) auth
    const lambdaFuncMessageAuth = new lambda.Function(
      this,
      "ChimeMessageAPIAuth",
      {
        code: lambda.Code.asset(`${__dirname}/lambda`),
    ...
    //// Integration
    const connectIntegration = new v2.CfnIntegration(
      this,
    ...
    const disconnectIntegration = new v2.CfnIntegration(
      this,
    ...
    const messageIntegration = new v2.CfnIntegration(
      this,
