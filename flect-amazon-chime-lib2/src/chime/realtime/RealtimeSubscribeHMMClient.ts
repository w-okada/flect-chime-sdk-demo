...
export class RealtimeSubscribeHMMClient {
    ...
    get amongUsServer(): RealtimeSubscribeHMMModuleAmongUsServer | null {
        return this._amongUsServer;
    }
    ...
    constructor(chimeClient: FlectChimeClient, restApiClient: RestApiClient) {
        ...
        this._chimeClient.meetingSession?.audioVideo?.realtimeSubscribeToReceiveDataMessage(RealtimeDataApp.HMM, this.receiveHMMData);
        this.updateHMMInfo();
    ...
    get hmmPublicIp(): string | null {
        return this._hmmPublicIp;
    }
    private _hmmLastStatus: string | null = null;
    get hmmLastStatus(): string | null {
        return this._hmmLastStatus;
    }

    private _hmmActive: boolean = false;
    get hmmActive(): boolean {
        return this._hmmActive;
    }
    private _hmmRecording: boolean = false;
    get hmmRecording(): boolean {
        return this._hmmRecording;
    }
    private _hmmShareTileview: boolean = false;
    get hmmShareTileview(): boolean {
        return this._hmmShareTileview;
    }

    private _hmmLastUpdate: number = 0;
    get hmmLastUpdate(): number {
        return this._hmmLastUpdate;
    }
