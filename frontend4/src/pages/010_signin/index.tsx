                ...
                <form className={classes.form} noValidate>
                    ...
                    <Grid container direction="row" alignItems="center">
                        <div style={{ width: "33%", margin: "5px" }}>
                            <a href="index.html">
                                <img src="/resources/chime/title.png" style={{ width: "100%" }} alt="chime" />
                            </a>
                        </div>
                        <div style={{ width: "33%", margin: "5px" }}>
                            <a href="index.html?mode=amongus">
                                <img src="/resources/amongus/title.png" style={{ width: "100%", background: "black" }} alt="amongus" />
                            </a>
                        </div>
                    </Grid>
