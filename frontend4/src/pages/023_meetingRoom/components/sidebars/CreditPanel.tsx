...
export const CreditPanel = () => {
    ...
    return (
        <div className={classes.root}>
            ...
            <Typography variant="body2">
                This program uses the musics and sound effects from{" "}
                <a href="https://otologic.jp" rel="noopener noreferrer" target="_blank">
                    OtoLogic
                </a>
            </Typography>
            <Typography variant="body2">
                This program uses the images from{" "}
                <a href="https://www.irasutoya.com/" rel="noopener noreferrer" target="_blank">
                    irasutoya
                </a>
            </Typography>
        </div>
