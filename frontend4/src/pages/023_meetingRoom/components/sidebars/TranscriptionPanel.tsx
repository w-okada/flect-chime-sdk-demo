    ...
    return (
        <div className={classes.root}>
            <div className={classes.margin}>
                {transcriptionViewArea}
            </div>
            
            <div >
                <Button size="small" className={classes.margin} onClick={()=>{ chimeClient!.startTranscribe("ja-JP")}}>
                {/* en-US | en-GB | es-US | fr-CA | fr-FR | en-AU | it-IT | de-DE | pt-BR | ja-JP | ko-KR | zh-CN */}
                    start transcribe
                </Button>
                <Button size="small" className={classes.margin} onClick={()=>{ chimeClient!.stopTranscribe()}}>
                    stop transcribe
                </Button>
