                    ...
                    <form className={classes.form} noValidate>
                        ...
                        <div style={{ display: "flex" }}>
                            <div style={{ width: "50%" }}>
                                ...
                                <Typography variant="body2">Input movie instead of the camera. When you use this featurem, camera device and microhpone device, virtual background are not choosen.</Typography>
                            </div>
                            <div style={{ width: "50%" }}>
                                <Button
                                    variant="outlined"
