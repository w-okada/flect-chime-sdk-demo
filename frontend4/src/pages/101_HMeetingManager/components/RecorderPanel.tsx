...
export const RecorderPanel = () => {
    ...
    const { chimeClient, startRecordRequestCounter, stopRecordRequestCounter, startShareTileviewRequestCounter, stopShareTileviewRequestCounter, terminateHMMRequestCounter } = useAppState();
    ...
    ////// (X) View /////
    const allTileIds = chimeClient!.getTilesWithFilter(false, false, true).reduce((pre, cur) => {
        return `${pre}_${cur.boundAttendeeId}`;
    }, "");
            ...
            return (
                <>
                    <div style={{ display: "flex", flexDirection: "column" }}>
                        ...
                        <div>ALL:{all_rec.started ? "STARTED!!" : "STOPPED"}</div>
                        <div>Active:{active_rec.started ? "STARTED!!" : "STOPPED"}</div>
                    </div>
                </>
            );
        } else {
